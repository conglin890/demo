Ext.define('HowToApply.view.Student3', {
			extend : 'Ext.Panel'
		});
	...
	items : [{
		...
		items : [{
					...
					items : [{
								...
								html : 'DO YOU RECEIVE GOVERNMENT ASSISTANCE:'
							}, {
								xtype : 'button',
								width : 100,
								height : 35,
								...
								handler : function() {
									if ('switch_off' == this.getCls()) {
										...
										Ext.getCmp('student3_form').setHidden(false);
								
											
			
									} else {
										this.setCls('switch_off');
										Ext.getCmp('student3_form').setHidden(true);
